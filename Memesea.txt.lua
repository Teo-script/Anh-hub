...
local Window = redzlib:MakeWindow({ Title = "HoangAnh : Meme Sea", SubTitle = "by HoangAnh", SaveFolder = "redzHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://106007402014282", BackgroundTransparency = 0 },
