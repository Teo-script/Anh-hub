...
local Window = WindUI:CreateWindow({
    Title = "HoangAnh Hub | 99 Night in Forest",
    Icon = "",
    IconThemed = true,
    Author = "By HoangAnh Hub",
    Folder = "Monster Hub",
...
Tabs.Info:Button({
    Title = "YouTube",
    Desc = "I No Have youtube",
    Callback = function()
        setclipboard("no have")
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "YouTube",
            Text = "copy link YouTube!",
            Duration = 3
        })
    end
})
...
Tabs.Info:Button({
    ...
    Desc = "Tiktok me",
    Callback = function()
        setclipboard("https://www.tiktok.com/@94_giahuy")
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "TikTok",
...
Tabs.Info:Button({
    Title = "Discord",
    Desc = "wait sever discord",
    Callback = function()
        setclipboard("wait sever!")
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Discord",
...
Tabs.Fly:Button({
    Title = "Fix Lag (50%)",
    Description = "Optimize game effects",
    Default = false,
    Callback = function(state)
        FixLagEnabled = state
        if state then
...
Tabs.Fly:Toggle({
    Title = "FullBright",
    Description = "See clearly at night",
    Default = false,
    Callback = function(state)
