...
local Window = Fluent:CreateWindow({
	...
	SubTitle = "Bây nhỏ thì bú dú mẹ đi🗿",              -- 👈 đổi mô tả phụ
	TabWidth = 157,
...
-- 📑 Các tab (mục chính)
local Tabs = {
	Main0 = Window:AddTab({ Title = "Bí ẩn xạo cak" }),  -- 👈 đổi tên tab 1
	...
	Main4 = Window:AddTab({ Title = "grow a garden chim" }),    -- 👈 đổi tên tab 5
...
Tabs.Main4:AddButton({
	...
	Description = "speed hub haha",-- 👈 mô tả
	Callback = function()
		local Settings = {
...
Tabs.Main1:AddButton({
	Title = "HoangAnh redz",                             -- 👈 tên nút hiển thị
	Description = tao chịu thằng t",-- 👈 mô tả
	Callback = function()
		local Settings = {
			JoinTeam = "Pirates";   -- 👈 team mặc định: Pirates hoặc Marines
			Translator = true;      -- 👈 bật dịch sang tiếng Việt nếu có
		}
	    loadstring(game:HttpGet("https://raw.githubusercontent.com/Teo-script/Anh-hub/refs/heads/main/HoangAnhpremium.lua"))() -- 👈 link script tải
	end
})

Tabs.Main2:AddButton({
	Title = "Chill hub",                             -- 👈 tên nút hiển thị
	Description = "Ngon lắm thử đi",-- 👈 mô tả
	Callback = function()
		local Settings = {
			JoinTeam = "Pirates";   -- 👈 team mặc định: Pirates hoặc Marines
			Translator = true;      -- 👈 bật dịch sang tiếng Việt nếu có
...
Tabs.Main2:AddButton({
	...
	Description = "Mới update luôn",-- 👈 mô tả
	Callback = function()
		local Settings = {
			JoinTeam = "Pirates";   -- 👈 team mặc định: Pirates hoặc Marines
			Translator = true;      -- 👈 bật dịch sang tiếng Việt nếu có
