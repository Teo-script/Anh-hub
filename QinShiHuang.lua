...
local v466 = loadstring(game:HttpGet("https://raw.githubusercontent.com/AnhDangNhoEm/UiRedz/refs/heads/main/RedzUiV.txt"))():MakeWindow({
    Title = "Qin Shi Huang Hub",
    SubTitle = "by real_simo",
...
l_ImageButton_0.Image = "rbxassetid://120213707198275"
...
v494:AddSlider({
    Title = "Speed Ch\225\186\161y by qinshihuang",
    Min = 26,
    Max = 300,
...
v494:AddSlider({
    Title = "Nh\225\186\163y Cao by qinshihuang",
    Min = 50,
    Max = 500,
