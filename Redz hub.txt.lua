...
loadstring(game:HttpGet("https://pastebin.com/raw/Un7it79p"))()
...
local Window = redzlib:MakeWindow({ Title = "Conan hub : Meme sea", SubTitle = "by real_hoanganh", SaveFolder = "redzHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://90235470995339", BackgroundTransparency = 0 },
  Corner = { CornerRadius = UDim.new(0, 6) }
})

local Tabs = {
  Discord = Window:MakeTab({"Sẽ Gầy", "Info"}),
  MainFarm = Window:MakeTab({"Haha mày ngu", "Home"}),
  Items = Window:MakeTab({"Lọ vương","Swords"}),
  Stats = Window:MakeTab({"Má mày", "Signal"}),
  Teleport = Window:MakeTab({"Lồn", "Locate"}),
  Shop = Window:MakeTab({"Cặc", "ShoppingCart"}),
  Misc = Window:MakeTab({"Đi ỉa", "Settings"}),
}
